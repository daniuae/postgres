...
VALUES
(21, 'Smith White', 25, 'Engineering', 555-7878, '2023-01-09', 4, 58000, 103),
(22, 'Anna Harris', 32, 'Sales', 555-8989, '2017-03-06', 17, 66000, 105);
...
-- Find departments where the average salary is above 60000
SELECT department,name ,SUM(Salary) AS AverageSalary
FROM Employees
GROUP BY department
HAVING (money(SUM(Salary)/count(*))) > money(60000);
...
VALUES
--(21, 2, '2024-04-02', 1500.00, NULL, 'Laptop', 'West', 'Repeat customer'),
--(22, 5, '2024-04-15', 850.00, NULL, 'Tablet', 'North', NULL)
...
-- ROLLBACK;
SELECT ROUND(123.456,2),ABS(-10),CEIL(12.1),FLOOR(12.9),MOD(10,3);
SELECT EXTRACT(YEAR FROM hire_date), DATEDIFF(year, hire_date, GETDATE()), 
...
SELECT 
COALESCE(revenue, 0) AS ActualCommission 
FROM Sales; 
