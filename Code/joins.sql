...
--(3, 'Catherine Lee', 31, NULL, 555-9101, '2019-01-08', 7, 95000, 103),
(4, 'David Kim', 28,NULL , 555-1122, '2020-02-17', 3, 70000, NULL),
...
SELECT E.name,D.department_name FROM employees_1 E LEFT JOIN Departments D ON E.id
= D.dept_id;
